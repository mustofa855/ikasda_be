...
from .views import (
    AlumniGroupingView, AuditLogViewSet, AuditReportView, BPADashboardView, EventSupervisionView, MyEventRegistrationListView, NewsViewSet, EventViewSet, DonationViewSet, FeedbackViewSet,
